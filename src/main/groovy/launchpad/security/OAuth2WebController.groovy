...
class OAuth2WebController {
    ...
    ModelAndView getAccessConfirmation(Map<String, Object> model, HttpServletRequest request) throws Exception {
    ...
    private static String TEMPLATE = '''<html><body><h1>Tim's OAuth Approval</h1> 
